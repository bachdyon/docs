...
description: "5 biến môi trường trong .env để bật full features"
icon: "key"
---

Repo dùng 5 API key, lưu trong file `.env` ở root. File mẫu là [`env.example`](https://github.com/bachdyon/video-automator-skills/blob/main/env.example).
