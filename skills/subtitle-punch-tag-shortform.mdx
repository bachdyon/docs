---
title: "subtitle-punch-tag-shortform"
description: "Short-form subtitle normal + PUNCH đồng bộ word_id; chunk script; punch chỉ do LLM suy luận; ~7–8 từ/chunk"
icon: "bolt"
---

<Info>
  **Skill ID**: `$subtitle-punch-tag-shortform` · [Source](https://github.com/bachdyon/video-automator-skills/blob/main/skills/subtitle-punch-tag-shortform/SKILL.md)
</Info>
