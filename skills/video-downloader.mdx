...
<Info>
  **Skill ID**: `$video-downloader` · [Source](https://github.com/bachdyon/video-automator-skills/blob/main/skills/video-downloader/SKILL.md) · Provider API: [TikWM](https://www.tikwm.com/)
</Info>
