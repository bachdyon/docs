---
title: "free-tts"
description: "TTS miễn phí/local VieNeu-TTS khi thiếu AUSYNCLAB_API_KEY hoặc user yêu cầu — preset, clone, registry .shared"
icon: "microphone-lines"
---

<Info>
  **Skill ID**: `$free-tts` · [Source](https://github.com/bachdyon/video-automator-skills/blob/main/skills/free-tts/SKILL.md) · [VieNeu-TTS](https://github.com/pnnbao97/VieNeu-TTS)
</Info>
...
```bash
.venv/bin/python skills/free-tts/scripts/free_tts.py \
...
```bash
.venv/bin/python skills/free-tts/scripts/free_tts.py --list-named-voices
```

Liệt kê preset voices:

```bash
.venv/bin/python skills/free-tts/scripts/free_tts.py --list-voices
```
