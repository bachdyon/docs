...
description: "POST /v1/media/upload-direct Zernio — Bearer auth, file tối đa 25MB, URL tạm ~7 ngày"
icon: "cloud-arrow-up"
---

<Info>
  **Skill ID**: `$zernio-upload-direct` · [Source](https://github.com/bachdyon/video-automator-skills/blob/main/skills/zernio-upload-direct/SKILL.md) · [Zernio docs](https://docs.zernio.com/messages/upload-media-direct)
</Info>
