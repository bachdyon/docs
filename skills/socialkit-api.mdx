...
<Info>
  **Skill ID**: `$socialkit-api` · [Source](https://github.com/bachdyon/video-automator-skills/blob/main/skills/socialkit-api/SKILL.md) · Provider API: [SocialKit](https://docs.socialkit.dev/)
</Info>
