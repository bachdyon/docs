...
description: "Tạo hoặc chỉnh ảnh với KIE GPT Image 2 (text-to-image / image-to-image), poll task và tải kết quả"
icon: "image-plus"
---

<Info>
  **Skill ID**: `$create-edit-image-gpt-image-2` · [Source](https://github.com/bachdyon/video-automator-skills/blob/main/skills/create-edit-image-gpt-image-2/SKILL.md) · [KIE GPT Image 2](https://docs.kie.ai/market/gpt/gpt-image-2-text-to-image)
</Info>
