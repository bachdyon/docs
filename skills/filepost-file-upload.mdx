...
description: "Upload file lên FilePost API, lấy URL CDN cố định; list, get, delete bằng client Python kèm repo"
icon: "cloud-arrow-up"
---

<Info>
  **Skill ID**: `$filepost-file-upload` · [Source](https://github.com/bachdyon/video-automator-skills/blob/main/skills/filepost-file-upload/SKILL.md) · [FilePost docs](https://filepost.dev/docs)
</Info>
