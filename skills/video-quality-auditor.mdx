...
<Info>
  **Skill ID**: `$video-quality-auditor` · Source: `skills/video-quality-auditor/SKILL.md`
</Info>
...
```bash
.venv/bin/python skills/video-quality-auditor/scripts/audit_video.py \
  --job jobs/<job_id> \
  --pass-index 1

.venv/bin/python skills/video-quality-auditor/scripts/render_html_report.py \
  --job jobs/<job_id> \
  --pass-index 1

.venv/bin/python skills/video-quality-auditor/scripts/apply_fix_batch.py \
  --job jobs/<job_id> \
  --pass-index 1
```
