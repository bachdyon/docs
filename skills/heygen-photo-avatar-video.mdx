...
description: "Video nhân hiệu / talking-head từ một ảnh + audio qua HeyGen Image to Video (POST /v3/videos)"
icon: "user"
---

<Info>
  **Skill ID**: `$heygen-photo-avatar-video` · [Source](https://github.com/bachdyon/video-automator-skills/blob/main/skills/heygen-photo-avatar-video/SKILL.md) · [HeyGen Image to Video](https://developers.heygen.com/image-to-video-1)
</Info>
