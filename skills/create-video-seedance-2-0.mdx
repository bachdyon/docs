...
description: "Video AI Bytedance Seedance 2.0 Fast qua KIE: text-to-video, first/last frame, multimodal reference"
icon: "clapperboard"
---

<Info>
  **Skill ID**: `$create-video-seedance-2-0` · [Source](https://github.com/bachdyon/video-automator-skills/blob/main/skills/create-video-seedance-2-0/SKILL.md) · [KIE Seedance 2.0 Fast](https://docs.kie.ai/market/bytedance/seedance-2-fast)
</Info>
