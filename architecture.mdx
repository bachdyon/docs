...
Bạn có thể hình dung VAS như một dây chuyền làm video. Mỗi video là một **job** riêng trong thư mục `jobs/<job_id>/`. Mỗi bước của dây chuyền làm một việc cụ thể, ghi kết quả vào `source/`, rồi bước tiếp theo đọc kết quả đó để làm tiếp.
